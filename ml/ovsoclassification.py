...
from MyLogisticRegressionOvsO import My_OneVsOne_Logistic_Regression
...
#model = OneVsOneClassifier(LogisticRegression(max_iter=8000))
model=My_OneVsOne_Logistic_Regression(max_iter=20,eta0=0.1,alpha=0.0001)
...
with open("onevso_reg_model.pkl", 'wb') as file:  
